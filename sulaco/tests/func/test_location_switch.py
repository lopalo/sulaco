...
class TestLocationSwitch(BasicFuncTest):
    ...
    def runTest(self):
        ...
        self.run_location('loc_X', 'tcp://127.0.0.1:8770',
                                   'tcp://127.0.0.1:8771')
        self.run_location('loc_Y', 'tcp://127.0.0.1:8772',
                                   'tcp://127.0.0.1:8773')
