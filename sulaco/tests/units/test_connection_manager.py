...
class TestLocationMixin(unittest.TestCase):
    ...
    def test_add_user_to_location(self):
        ...
        self.assertEqual([
            call(zmq.SUBSCRIBE, 'private_message_from_location:fooloc:111'),
            call(zmq.SUBSCRIBE, 'public_message_from_location:fooloc')],
    ...
    def test_remove_connection(self):
        ...
        connman._sub_socket.setsockopt.call_args_list)
        self.assertEqual([
            call(zmq.SUBSCRIBE, 'private_message_from_location:megaloc:222'),
            call(zmq.SUBSCRIBE, 'public_message_from_location:megaloc'),
            call(zmq.UNSUBSCRIBE, 'private_message_from_location:megaloc:222'),
            call(zmq.UNSUBSCRIBE, 'public_message_from_location:megaloc')],
        connman._locs_sub_socket.setsockopt.call_args_list)
